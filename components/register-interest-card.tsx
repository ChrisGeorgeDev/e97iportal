...
export function RegisterInterestCard({
  ...
  const registered = confirmedAmount !== null
  ...
  return (
    // flex-1 on the excerpt absorbs the leftover height from grid
    // row-stretching, so the button/form block bottom-aligns across cards
    // of different excerpt lengths instead of trailing right after its own text.
